...
Plot18 <- ggplot(loans) + 
  ...
  labs(title="Plot18 - Grade Vs Revolving Utilization",x="Sub-Grade",y="Revolving Utilization(%)",fill="Grade")
Plot18
...
Plot20 <- ggplot(data = loans %>% 
  ...
  labs(title="Plot20 - Grade vs DTI", x = "Grade", y = "Sub-Grade", fill= "Median DTI")
Plot20
...
# For PPT
grid.arrange(Plot03, Plot09, Plot04, Plot14, Plot10, Plot13)
grid.arrange(Plot05, Plot15, Plot12, Plot17)
grid.arrange(Plot18, Plot19)
grid.arrange(Plot20, Plot21)
grid.arrange(Plot23, Plot24)  
grid.arrange(Plot04, Plot05, Plot09, Plot10,  Plot14, Plot15, Plot12, Plot17, nrow = 2, ncol = 4)
